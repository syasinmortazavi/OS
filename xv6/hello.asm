...
int main(void){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	//getpinfo(getpid());
	exit();
  11:	e8 ac 02 00 00       	call   2c2 <exit>
  16:	66 90                	xchg   %ax,%ax
  18:	66 90                	xchg   %ax,%ax
  1a:	66 90                	xchg   %ax,%ax
  1c:	66 90                	xchg   %ax,%ax
...
void print(struct syscall_info info_array [sys_call_num][p_num]){
  ...
  2c:	8d 5f 08             	lea    0x8(%edi),%ebx
  2f:	81 c7 88 3e 00 00    	add    $0x3e88,%edi
  35:	8d 76 00             	lea    0x0(%esi),%esi
    if(info_array[i][0].pid != -1){
  38:	83 7b 04 ff          	cmpl   $0xffffffff,0x4(%ebx)
  3c:	74 29                	je     67 <print+0x47>
  3e:	8d b3 40 06 00 00    	lea    0x640(%ebx),%esi
  44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"%d",info_array[i][j].value);
  48:	83 ec 04             	sub    $0x4,%esp
  4b:	ff 33                	pushl  (%ebx)
  4d:	83 c3 10             	add    $0x10,%ebx
  50:	68 68 07 00 00       	push   $0x768
  55:	6a 01                	push   $0x1
  57:	e8 b4 03 00 00       	call   410 <printf>
      for (int j = 0; j < p_num; j++)
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	39 de                	cmp    %ebx,%esi
  61:	75 e5                	jne    48 <print+0x28>
  for (int i = 0; i < sys_call_num; i++){
  63:	39 fb                	cmp    %edi,%ebx
  65:	75 d1                	jne    38 <print+0x18>
}
  67:	8d 65 f4             	lea    -0xc(%ebp),%esp
  6a:	5b                   	pop    %ebx
  6b:	5e                   	pop    %esi
  6c:	5f                   	pop    %edi
  6d:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 6b 07 00 00       	mov    $0x76b,%ebx
        while(*s != 0){
 ...
 5e1:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 737:	0a 00 00 
 73a:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 48 0a 00 00       	mov    $0xa48,%eax
 749:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 750:	00 00 00 
